...
genes = mapIds(org.Hs.eg.db, genSFI_NIT_res, 'ENTREZID', 'SYMBOL')
enrich.resultSFI_NIT <- enrichPathway(gene = genes, pvalueCutoff = 0.05, readable = T, organism = "human", universe = universe)
```
```{r SignificacionSFI_NIT_Plot_1, message=FALSE, echo=FALSE, warning=FALSE,fig.cap="Fig. 9: Barplot  SFI vs. NIT"}
...
genes = mapIds(org.Hs.eg.db, genELI_NIT_res, 'ENTREZID', 'SYMBOL')
enrich.resultELI_NIT <- enrichPathway(gene = genes, pvalueCutoff = 0.05, readable = T, organism = "human", universe = universe)
```
...
genes = mapIds(org.Hs.eg.db, genELI_NIT_res, 'ENTREZID', 'SYMBOL')
enrich.resultELI_SFI <- enrichPathway(gene = genes, pvalueCutoff = 0.05, readable = T, organism = "human", universe = universe)
```
